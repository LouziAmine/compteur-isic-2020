...
public:
    ...
    HSimConfigDecl * topModuleInstantiate() {
        ...
        HSim__s6 * topvh = 0;
        extern HSim__s6 * createWork_counter_test_selfcheck_beh_testbench_arch(const char*);
        topvh = createWork_counter_test_selfcheck_beh_testbench_arch("counter_test_selfcheck_beh");
